...
Dataset Overview - Total Observations: `r n_obs` - Target Variable: Outcome (binary: 0 = no diabetes, 1 = diabetes). - Mean Outcome: `r round(mean(df$Outcome), 3)`. About `r round(diabetes_rate, 1)`% of the patients in the dataset have diabetes.
