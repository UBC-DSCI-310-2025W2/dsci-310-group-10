...
all: reports/predicting_diabetes.html
...
results/model.rds results/test_data.rds: src/03_model.R data/processed_data.rds
	Rscript src/03_model.R data/processed_data.rds results/model.rds results/test_data.rds
# Step 4: Results
results/conf_mat.rds results/final_results.csv results/final_plot.png: src/04_results.R results/model.rds results/test_data.rds
