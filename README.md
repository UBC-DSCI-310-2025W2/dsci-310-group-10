...
After cloning the GitHub repository and restoring the environment, you can run `make clean` to remove previously generated outputs, followed by `make all` to regenerate the most up-to-date results.
